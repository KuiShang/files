...
class AcknowledgeMsg extends Message {
    ...
    getTemplate(msg) {
        ...
        temp += '<div class="acknowledge clearfix">' +
            '<div class=" list-text acknowledge-content"   data-msgtype="100001"   data-senderid="' + msg.senderId + '"  data-status="' + msg.status + '"  data-sendtime="' + msg.sendtime + '"><pre>' + msgbody + '</pre>' +
